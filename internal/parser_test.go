...
func TestCreateSQL(t *testing.T) {
	ts := []testCase{
		...
		},
		{
			...
			SQL:      "CREATE TABLE 'a'",
			Expected: Query{},
			Err:      fmt.Errorf("at CREATE TABLE: can't have empty table"),
		},
		{
		...
		},
		{
			...
			Expected: Query{
				Type:              Create,
				TableName:         "b",
				TableConstruction: [][]string{{"ID", "INT"}},
			},
			Err: nil,
		},
		{
			...
			Expected: Query{
				Type:              Create,
				TableName:         "c10",
				TableConstruction: [][]string{{"column1", "INT"}, {"column2", "CHAR", "20"}, {"column3", "BOOL"}, {"column4", "FLOAT"}},
			},
			Err: nil,
		},
		{
			...
			Expected: Query{
				Type:              Create,
				TableName:         "b",
				TableConstruction: [][]string{{"ID", "INT", "PRIMARY KEY"}},
			},
			Err: nil,
		},
		{
			...
			Expected: Query{
				Type:              Create,
				TableName:         "b",
				TableConstruction: [][]string{{"ID", "INT", "PRIMARY KEY"}, {"Column", "FLOAT", "UNIQUE", "NOT NULL"}, {"third", "CHAR", "50", "NOT NULL"}},
			},
			Err: nil,
		},
		{
			...
			Expected: Query{
				Type:              Create,
				TableName:         "MyTable10",
				TableConstruction: [][]string{{"column1", "INT", "PRIMARY KEY"}, {"column2", "CHAR", "20"}, {"column30", "BOOL"}, {"column400", "FLOAT"}},
			},
			Err: nil,
		},
	}
